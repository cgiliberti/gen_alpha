...
export class StanfordDailyScraper extends BaseScraper {
  readonly schoolSlug = 'stanford';
  readonly newspaperUrl = 'https://stanforddaily.com';
  ...
  async getRecentArticles(): Promise<ScrapedArticle[]> {
    ...
    try {
      const xml = await this.fetchXml('https://stanforddaily.com/feed/');
      ...
      console.error(`[StanfordDailyScraper] Failed:`, err);
    }
